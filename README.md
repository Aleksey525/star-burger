...
Ссылка на опубликованный сайт - [Starburger](https://star-burg.ru/)
...
После завершения работы скрипта, сайт будет доступен по [ссылке](https://star-burg.ru/) с `SSL` сертификатами и подключенной базой данных `PostgresQL`.
